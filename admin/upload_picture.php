...
// Create initial representative picture for mpo and jps files
...
add_event_handler('loc_end_add_uploaded_file', 'threed_pict_set_flags');
function threed_pict_set_flags($image_infos)
{
	global $threed_image_exts;
